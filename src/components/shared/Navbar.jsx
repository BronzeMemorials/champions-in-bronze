      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-60 bg-[#0d0b09] border border-bronze/20 shadow-2xl z-50"
          >
            {links.map((link) => (
              <Link
                key={link.to}
...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="bg-[#0a0704]/97 backdrop-blur-xl border-b border-bronze/15">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="xl:hidden bg-[#0a0704] border-b border-bronze/20 overflow-hidden"
          >
