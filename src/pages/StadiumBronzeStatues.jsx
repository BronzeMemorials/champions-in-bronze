...
export default function StadiumBronzeStatues() {
  return (
    <div className="bg-obsidian text-parchment">
      ...
      <QuoteForm title="Request Your Free Artwork Proof" subtitle="Tell us about your stadium installation — we'll deliver a digital proof within the hour." source="pro" />
