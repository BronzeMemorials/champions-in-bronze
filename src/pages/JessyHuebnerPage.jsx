...
import { ArrowRight, Trophy, Star, MapPin, Award, TrendingUp, Medal, Flag } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn delay={0.2}>
              <div className="rounded-sm overflow-hidden border-2 border-yellow-200 shadow-2xl">
                <img src={PLAQUE_IMG} alt="Jessy Huebner Hall of Fame bronze plaque — Wyndham Invitational Champion" className="w-full h-auto" />
              </div>
            </FadeIn>
            <FadeIn>
