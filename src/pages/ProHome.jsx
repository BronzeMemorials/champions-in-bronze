      ...
      <section className="relative min-h-screen flex items-end overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pb-20 sm:pb-28 pt-32 sm:pt-40 w-full">
          <FadeIn>
            ...
            <h1 className="font-serif sm:text-6xl md:text-8xl lg:text-[7rem] leading-[0.9] text-parchment w-full text-center text-3xl">ImmortalizeYour LegacyChampions Deserve to Live Forever</h1>
