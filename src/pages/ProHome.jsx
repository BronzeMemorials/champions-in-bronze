      ...
      <section className="relative min-h-screen flex items-end overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 pb-28 pt-40 w-full">
          <FadeIn>
            ...
            <p className="mt-8 max-w-2xl text-xl text-parchment/70 leading-relaxed font-sans font-light">Hall of Fame plaques, Custom 3Dbronze plaques, donor walls, busts, and commemorative recognition for universities, stadiums, and professional athletic organizations.
